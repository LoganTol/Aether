...
const Index = () => {
  return (
    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-50 w-full border-b border-border bg-background/85 backdrop-blur-md transition-colors duration-300 hover:border-primary/30 hover:bg-primary/15">
        <PageContainer width="wide" className="flex h-[4.5rem] items-center justify-between gap-4">
